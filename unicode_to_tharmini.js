function Unicode_To_Tharmini (text) {
    //return text + " Unicode_To_Bamini";
    //alert("Running Tharmini")
    text = text.replace(/ளி/g, "sp");
    text = text.replace(/ரி/g, "hp");
    text = text.replace(/ரீ/g, "hP");
    text = text.replace(/ரீ/g, "uP");
    text = text.replace(/ர்/g, "u;");
    text = text.replace(/ர்/g, "h;");
    text = text.replace(/ர்/g, "H");
    ...
    //text = text.replace(/டி/g, "lp");
    text = text.replace(/டீ/g, "lP");
...
//பூ
    ...
    text = text.replace(/வௌ/g, "ntt");
    text = text.replace(/வு/g, "T");    // -------------- updated 
    text = text.replace(/வ/g, "t");
    text = text.replace(/ழௌ/g, "noo");
    ...
    text = text.replace(/ஷ/g, "\\");    //<---------------Changed 17May2022
    ...
    text = text.replace(/வூ/g, "வு10");
    //text = text.replace(/பூ/g, "G\+");       //<---------------Changed 17May2022
    //text = text.replace(/பூ/g, "பு10");    //<---------------Changed 17May2022
    text = text.replace(/gூ/g, "G\+");        //<---------------Changed 17May2022 Not sure where this is originating from
    text = text.replace(/யூ/g, "A\+");
    text = text.replace(/யூ/g, "யு10");
    text = text.replace(/-/g, "\–");
    text = text.replace(/,/g, "\>");
    text = text.replace(/இ/g, "\,");     //<---------------Changed 17May2022

    //text = text.replace(/,/g, "\>");    //<---------------Changed 17May2022
    //text = text.replace(/./g, ".கூ"); // Bug fix sentence eng, ".கூ); தூ
